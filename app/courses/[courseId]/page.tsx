...
import { HomeworkTab } from "@/components/course/homework-tab"
import { AttendanceTab } from "@/components/course/attendance-tab"
import { BonusCreditsDialog } from "@/components/admin/bonus-credits-dialog"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <CardHeader>
            <div className="flex items-start justify-between">
              ...
              <div className="flex items-center space-x-2">
                {isOrganizer && <BonusCreditsDialog courseId={params.courseId} />}
                {user && (
        ...
        <Tabs defaultValue="discussion" className="space-y-6">
          <TabsList className={`grid w-full ${isOrganizer ? "grid-cols-5" : "grid-cols-4"}`}>
            ...
            {isOrganizer && <TabsTrigger value="attendance">Attendance</TabsTrigger>}
          </TabsList>

          <TabsContent value="discussion">
            <PostFeed courseId={params.courseId} title={`${course.title} Discussion`} isOrganizer={isOrganizer} />
          </TabsContent>
          ...
          <TabsContent value="homework">
            <HomeworkTab courseId={params.courseId} isOrganizer={isOrganizer} />
          </TabsContent>

          {isOrganizer && (
            <TabsContent value="attendance">
              <AttendanceTab courseId={params.courseId} />
            </TabsContent>
          )}
        </Tabs>
      </div>
